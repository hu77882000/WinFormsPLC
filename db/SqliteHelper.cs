...
namespace WinFormsPLC.db
{
    public static class SqliteHelper
    {
        // 连接字符串
        private static readonly string connStr = "Data Source=" + Directory.GetCurrentDirectory() + "\\DB\\PLCDB.sqlite;Version=3;";
        ...
        public static void CreateTable()
        {
            ...
            if (cn.State != System.Data.ConnectionState.Open)
            {
                ...
                {
                    Connection = cn,//把 SQLiteCommand的 Connection和SQLiteConnection 联系起来
                    CommandText = "CREATE TABLE IF NOT EXISTS PT_OrederInfo( id varchar(50) PRIMARY KEY,ItemCode varchar(100),ItemName varchar(100) ,Creater varchar(100),CreateDate date, Isdelete varchar(2), note text ) ;" + //输入SQL语句  订单号 信息
        ...
        public static void DeleteTable()
        {
            ...
            if (cn.State != System.Data.ConnectionState.Open)
            {
                ...
                {
                    Connection = cn,
                    CommandText = "DROP TABLE IF EXISTS t1"
                };
                cmd.ExecuteNonQuery();
            }
            cn.Close();
