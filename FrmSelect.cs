...
namespace WinFormsPLC
{
    public partial class FrmSelect : Form
    {
        ...
        private void uiImageButton1_Click(object sender, EventArgs e)
        {
            ...
            ///将窗体设置成子窗体
            FrmAddIPEquipment sub = new FrmAddIPEquipment
            {
                TopLevel = false,  //取消窗体的置顶模式
                Dock = DockStyle.Fill,//把子窗体设置为控件

                FormBorderStyle = FormBorderStyle.None//取消边框
            }; //new 对象
        ...
        private void uiImageButton3_Click(object sender, EventArgs e)
        {
            dockPanel1.Controls.Clear();
            ///将窗体设置成子窗体
            FrmMonitoring sub = new FrmMonitoring
            {
                TopLevel = false,  //取消窗体的置顶模式
                Dock = DockStyle.Fill,//把子窗体设置为控件
        ...
        private void uiImageButton2_Click(object sender, EventArgs e)
        {
            dockPanel1.Controls.Clear();
            ///将窗体设置成子窗体
            HslFormContent sub = new HslFormContent
            {
                TopLevel = false,  //取消窗体的置顶模式
                Dock = DockStyle.Fill,//把子窗体设置为控件
        ...
        {
            SqliteHelper.Delete();
            bool dbExist = File.Exists("DB" + "\\" + "PLCDB1.sqlite");    //通过File.Exists函数判断数据库文件是否已经存在
